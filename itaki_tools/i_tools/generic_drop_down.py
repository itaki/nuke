...
class StockIcons():
    def __init__(self):
        ...
        self.icon_dict = self.make_icon_dict()
    ...
    def make_icon_dict(self):
        ...
        for icon in self.stock_icons:
            ...
            icon_dict[icon] = f"{os.path.join(self.stock_icons_path, icon)}"
        return icon_dict
...
class IconSelectorPanel(nukescripts.PythonPanel):
    def __init__(self):
        ...
        self.icon_menu = nuke.Pulldown_Knob("icon", "Icon",  self.icon_list_manager.icon_dict)
