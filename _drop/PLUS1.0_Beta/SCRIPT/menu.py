...
Dir.addCommand( 'Open Script Folder', "openScriptFolder()", icon='Dscript.png')
...
Dir.addSeparator()
Dir.addCommand( 'Read from Write', "PlusRFWLink_toolbar()", icon='Drfw.png')
...
Organize.addSeparator()
Organize.addCommand( 'Lock Panel', 'showLockPanel()',  icon = 'Olp.png')
