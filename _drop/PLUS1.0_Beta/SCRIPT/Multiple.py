...
class multiplereads( nuke.PythonPanel ):
    def __init__( self, node ):
        nuke.PythonPanel.__init__( self, 'Multiple Reads' )
...
class multiplenodes( nuke.PythonPanel ):
    def __init__( self, node ):
        nuke.PythonPanel.__init__( self, 'Multiple Nodes' )
