# Add this to your ~/.nuke/init.py file.

# ---   NUKE ICON TOOLKIT   -----------------------------------

# Load in ~/.nuke subdirectories -- you will need to create these as-per README.txt
#nuke.pluginAddPath('./icons')
#nuke.pluginAddPath('./icons/nuke_icon_toolkit')
nuke.pluginAddPath('./originals')
#nuke.pluginAddPath('./examples')

# Re-create Nuke's default menus to use the new, high-res icons.
