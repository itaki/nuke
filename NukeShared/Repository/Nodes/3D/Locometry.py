...
class LocoWidget(QtWidgets.QWidget):
    def __init__(self):
        ...
        self.frangeLBL = QtWidgets.QLabel('Frame Range')
        self.firstLE = QtWidgets.QLineEdit()
        self.lastLE = QtWidgets.QLineEdit()
        self.trackBTN = QtWidgets.QPushButton('snap')
    ...
    def trackSelectedVertices(self):
        try:
            if len(getPoints())==3:
                ...
                nuke.message('LOCOMETRY: Invalid Frame Range.')
