...
def presetBackdrop():
    customPreset = None
    sep = '"'
    presets = ['Camera_Tracker',
                'Camera_Projection','Camera_Setup','CG','Cleanup','Controllers','Color_Correction','Despill','Edge_Fixes',
                'Elements','FX', "Grain", 'Key','Matte','Lens_Flare','Light_Setup','Light_Wrap','Output','Previous_Versions',
                'References','Relight','Resources','Rig_Removal','Roto','Set_Extension','Stereo_Fixes','Temp','Test','Transformations']
    '''presets = ['Additive_Key','Bloom','Camera_Projection','Camera_Setup','CG','CG:Ambient','CG:Diffuse','CG:Reflection',
                'CG:Refraction','CG:Shadow','CG:Specular','Cleanup','Controllers','Color_Correction','Despill','Edge_Fixes',
                'Elements','FX', "Grain", 'Key','Matte','Lens_Flare','Light_Setup','Light_Wrap','Output','Previous_Versions',
                'References','Relight','Resources','Rig_Removal','Roto','Set_Extension','Stereo_Fixes','Temp','Test','Transformations']
    '''
