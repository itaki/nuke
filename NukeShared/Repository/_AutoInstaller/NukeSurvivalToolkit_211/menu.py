...
# This determines where the menus load
nst_menu = True # loads NST as it's own menu
...
def create_menus(location):
    ...
    # Decide which way to create the menus
    if location == 'nst':
        pass

    elif location == 'organized':
        # Orgainize NST Gizmos in Nuke Menus
        m = nuke.menu('Nodes')
