# Updated and modified by itaki from V!ctor tools
# https://benmcewan.com/blog/2019/06/03/quick-tip-programmatically-dealing-with-hex-colour-in-nuke/
...
def backdrop_presets():
    ...
    presets = ['2D_Tracking','3D_Tracking','Additive_Key','Camera_Projection','Camera_Setup','CG','CG:Ambient','CG:Diffuse','CG:Reflection','CG:Refraction','CG:Shadow','CG:Specular','Cleanup','Controllers','Color_Correction','Despill','Edge_Fixes','Key','Matte','Lens_Flare','Light_Wrap','Output','Previous_Versions','References','Relight','Resources','Rig_Removal','Roto','Set_Extension','Test', 'Transformations']
    ...
    # Backdrop presets
    if customPreset == '2D_tracking':
        presetLabel = '2D Tracking'
        presetIcon = 'Tracker.png'
        presetColor = colorsys.hsv_to_rgb(0.819, 0.286, 0.329)
    
    if customPreset == '3D_Tracking':
        presetLabel = '3D Tracking'
        presetIcon = 'CameraTracker.png.png'
    ...
    if customPreset is not None:
        ...
        hexColour = int('%02x%02x%02x%02x' % (r,g,b,1), 16)
        print (hexColour)
